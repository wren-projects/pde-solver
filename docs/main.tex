...
In our implementation, each spatial dimension is associated with the
physical index of a single TT core. A derivative along axis $k$ is
therefore approximated by applying a finite-difference rule directly
to that core while keeping all remaining cores unchanged.
...
This approach is specific to our implementation and differs
from classical TT methods based on TT-matrix representations
of differential operators.
%==================================================
\subsection{Divergence using gradients}
%==================================================
...
%==================================================
\subsection{Laplace operator using gradients}
%==================================================
...
This means that second derivatives are not built from a TT-matrix.
Instead, they are computed by repeated finite differences on TT cores.
...
This Kronecker structure motivates many classical TT-matrix methods,
although our implementation applies differential operators directly to
TT cores rather than constructing TT-matrix operators explicitly.
...
TTD-based procedures described in Sections 4.9 and 4.10.
No explicit differential operator matrices are assembled.
